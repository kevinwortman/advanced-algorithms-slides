...
truly optimal.
\begin{itemize}
  \item proximity to optimality is quantified, \textbf{proven}
  \item ``approximation'', ``approximate'' are technical terms; use other words
    like ``decent'' for informal ideas about near-optimality
  \item suitable for business scenarios where approximate solutions are adequate
