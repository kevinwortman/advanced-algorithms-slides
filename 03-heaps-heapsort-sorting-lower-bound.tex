...
Let parent node $p$ have children $l, r$ \stanza

Recall \textbf{BST invariant}: $l.key < p.key < r.key$ \stanza
...
Implies
\begin{enumerate}
  \item BST is totally sorted
  \item heap is ``halfway'' sorted; can tell parent comes before children,
    but siblings are unsorted
