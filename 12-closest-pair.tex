...
\title{12. Closest Pair Problem}
\subtitle{CPSC 535 $\sim$ Fall 2019}
\author{Kevin A. Wortman}
\institute{ \includegraphics[height=2cm]{csuf-logo-cmyk} }
\date{December 2, 2019 \stanza
...
\begin{enumerate}
  \item return Midterm 2
  \item Student Opinion Questionairres (SOQs)
  \item closest pair problem \stanza
\end{enumerate}
(this presentation is shorter than usual)
\end{frame}
